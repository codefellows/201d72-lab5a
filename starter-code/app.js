...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  let abSum = sum(a, b);
  let abcSum = sum(abSum[0], c);
  let abProduct = multiply(a, b);
  let abcProduct = multiply(abProduct[0], c);
  let sumString = `${a} and ${b} and ${c} sum to ${abcSum[0]}.`;
  let productString = `The product of ${a} and ${b} and ${c} is ${abcProduct[0]}.`;

  return [abcSum[0], abcProduct[0], sumString, productString];
}
